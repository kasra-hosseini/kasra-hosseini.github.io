...
None of those three was decided in a meeting, and all three now bind. This page is for naming what a system has already become, which gets you the failure mode that comes attached to the arrangement and the words to raise it with somebody who did not build it.
