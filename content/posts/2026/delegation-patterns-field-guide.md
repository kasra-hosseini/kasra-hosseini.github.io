...
That is what this page is for: not to argue anything, but to let you point at part of a system and say what it is. Naming a pattern buys you two concrete things: the failure mode that comes with it, which is usually already on its way, and the vocabulary to discuss a design with somebody who did not build it.
