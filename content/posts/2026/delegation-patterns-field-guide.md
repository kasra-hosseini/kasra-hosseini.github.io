...
*A companion reference to [Part 2](/posts/2026/agent-fabric-part2/) of The Agent Fabric. That post argues that splitting work between agents quietly creates authority. This one is the catalogue it draws on, and it is built to be searched rather than read.*
