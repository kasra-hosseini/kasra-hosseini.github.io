...
Then the first agent disagrees with the third about whether the test was fair, and something has to settle it. Nobody sits down to design that part. It gets settled by whichever agent the setup has been trusting, and trusting here means a number somebody started recording. Nobody writes that number down as a decision about whose judgement counts. It just becomes one.
