...
This is not confined to software. The same loop has been pointed at <a href="https://arxiv.org/abs/2304.05376" target="_blank" rel="noopener">chemistry</a>, where it proposes a compound, reads back what the equipment found, and picks the next thing to try, and at <a href="https://arxiv.org/abs/2408.06292" target="_blank" rel="noopener">research itself</a>, generating its own ideas, running the experiments, writing them up, and then reviewing its own drafts. Though be careful what you conclude from that. Most of these are not one agent improving alone; a model proposes, and something later, human or automated, throws nearly all of it out. What survives goes into the world, and what happens there feeds the next round.
