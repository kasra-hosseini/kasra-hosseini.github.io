...
This has already produced compounds that did not previously exist. DeepMind's GNoME proposed a vast set of candidate crystal structures and guessed which would be stable; Berkeley's A-Lab then made dozens of the genuinely new ones, largely unsupervised, in a lab where the loop ran the equipment. Something similar happens in chemistry with <a href="https://arxiv.org/abs/2304.05376" target="_blank" rel="noopener">ChemCrow</a>, and furthest of all with <a href="https://arxiv.org/abs/2408.06292" target="_blank" rel="noopener">The AI Scientist</a>, which generates its own ideas, runs the experiments, writes them up, and then reviews its own drafts.
