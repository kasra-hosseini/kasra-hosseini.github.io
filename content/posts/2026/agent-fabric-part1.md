...
<li><strong>2026-05-15:</strong> Expanded several notes and added new ones (Tierra, identity, network stability) in response to a detailed review by Håkan Jonsson. Thank you, Håkan, for the generous and thought-provoking feedback.</li>
...
- **Part 1: Why Agents May Form Societies** (you are here): two observations, the Loom Hypothesis (why isolated agents get woven together), and the path from isolation to interweaving
...
<a href="/posts/2026/agent-fabric-part2/">Part 2</a> follows this into a single support desk, where the record that decides which agent gets work turns into a rule nobody wrote. <a href="/posts/2026/agent-fabric-part3/">Part 3</a> takes up the governance that forms around such a desk, and who is left to argue with it. The full catalogues sit in two companion field guides, on <a href="/posts/2026/delegation-patterns-field-guide/">delegation patterns</a> and <a href="/posts/2026/governance-archetypes-field-guide/">governance archetypes</a>.
