...
Two words follow from that, and the difference matters for her specifically. The **institution** is the standing rule that flagged accounts like hers stay flagged. **Governance** is everything around it: applying that rule, and deciding who may change it. She lost to the first and had no access to the second. Memory alone would not have done it, since a cache remembers and governs nothing; what makes the desk's records different is that they decide who gets work tomorrow.
