...
Two things that are not enough on their own, though. Persistence alone would not do it, since a cache persists and governs nothing; what counts is authority over how work gets handed out, outliving the task that produced it. And the definition rests on enforcement, which does not transfer to software at all, and which matters enough that a later section is about nothing else.
