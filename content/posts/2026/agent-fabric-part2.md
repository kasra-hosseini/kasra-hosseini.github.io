...
Those trees stay short, for a reason that has nothing to do with good design. Every extra agent multiplies cost and latency, so budgets push relentlessly toward the shallowest arrangement that works. That arrangement also happens to have the fewest places for standing to build up, meaning the fewest agents whose past record quietly determines what they are trusted with next. Frugality and accountability turn out to be accidental allies.
