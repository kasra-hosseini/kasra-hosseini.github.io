...
*This post picks up where that pressure leads. It asks how agents divide work, and how governance structures form around them. One thread from Part 1 runs throughout: societies have two origins. Some are built top-down, when a company or team designs the structure; others form bottom-up, when individuals assemble agents from what is available. The two origins pull in different directions, and this post develops that distinction. Top-down societies tend toward hierarchy and doctrine; bottom-up ones tend toward markets and custodianship.*
