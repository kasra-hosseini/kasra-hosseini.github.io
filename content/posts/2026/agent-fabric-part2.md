...
On a phone the worst this costs is a suggestion you might have wanted. Now put several agents in a company and give one of them the job of deciding which of the others handles what. That is delegation, and the moment that agent starts consulting a record of who did well last time, the record is where the authority has gone. Somebody builds that on a Tuesday, and it does not feel like building an institution. It feels like adding logging.
